...
export declare class MdReferencesProvider extends Disposable {
    ...
    constructor(configuration: LsConfiguration, parser: IMdParser, workspace: IWorkspace, tocProvider: MdTableOfContentsProvider, logger: ILogger);
    ...
    getReferencesToFileInDocs(resource: URI, otherDocs: readonly ITextDocument[], token: CancellationToken): Promise<MdReference[]>;
